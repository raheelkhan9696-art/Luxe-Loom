          ...
          <form className="space-y-10">
            ...
            <section>
              <div className="flex justify-between items-end mb-4">
                ...
                <button type="button" className="text-[10px] text-gold underline tracking-widest uppercase">Log in</button>
              </div>
              <input 
                type="text" 
                placeholder="Email or mobile phone number" 
                className="w-full bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-gold outline-none transition-all placeholder:text-zinc-600 rounded-sm"
              />
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <select className="w-full bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-gold outline-none rounded-sm">
                    <option>Pakistan</option>
                    <option>United Kingdom</option>
                    <option>United States</option>
                  </select>
                </div>
                <input type="text" placeholder="First name" className="bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-gold outline-none rounded-sm" />
                <input type="text" placeholder="Last name" className="bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-gold outline-none rounded-sm" />
                <input type="text" placeholder="Address" className="col-span-2 bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-gold outline-none rounded-sm" />
                <input type="text" placeholder="Apartment, suite, etc. (optional)" className="col-span-2 bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-gold outline-none rounded-sm" />
                <input type="text" placeholder="City" className="bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-gold outline-none rounded-sm" />
                <input type="text" placeholder="Postal code" className="bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-gold outline-none rounded-sm" />
              </div>
            </section>
            ...
            <section className="bg-white/[0.02] border border-white/5 p-6 rounded-sm">
              ...
              <div className="flex items-center justify-between p-4 border border-gold/50 bg-gold/5 rounded-sm">
                <span className="text-sm">Cash on Delivery (COD)</span>
                <div className="w-4 h-4 rounded-full border-4 border-gold bg-black" />
              </div>
            </section>

            <button className="w-full bg-white text-black py-5 text-xs font-bold tracking-[0.3em] uppercase hover:bg-gold transition-colors duration-500 flex items-center justify-center gap-2 group">
              Complete Order
        ...
        <div className="max-w-sm mx-auto">
          ...
          <div className="flex gap-2 mb-8">
            <input 
              ...
              className="flex-1 bg-transparent border border-white/10 px-4 py-2.5 text-xs focus:border-gold outline-none transition-all rounded-sm"
            />
          ...
          <div className="space-y-3 pt-6 border-t border-white/5">
            ...
            <div className="flex justify-between items-center pt-4 border-t border-white/5">
              ...
              <div className="text-right">
                ...
                <span className="text-xl font-mono text-gold">Rs 1,599.00</span>
              </div>
            </div>
          </div>
