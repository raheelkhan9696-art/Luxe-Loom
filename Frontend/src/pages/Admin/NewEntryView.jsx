    ...
    <div className="min-h-screen bg-[#050505] text-zinc-300 pt-16 pb-20 px-6 md:px-12">
      <div className="max-w-[800px] mx-auto">
        ...
        <header className="mb-16 pb-8 border-b border-white/5">
          <p className="text-gold text-[10px] tracking-[0.5em] uppercase mb-3">Portfolio Curation</p>
        ...
        <form className="space-y-12">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {/* Primary Drop Zone */}
              <div className="md:col-span-2 group relative h-40 md:h-full aspect-[1/1] border-2 border-dashed border-white/10 hover:border-gold/40 rounded-sm flex flex-col items-center justify-center cursor-pointer transition-all bg-white/[0.01]">
                <UploadCloud size={24} className="text-gold mb-3 opacity-60 group-hover:opacity-100 transition-opacity" strokeWidth={1.2} />
          ...
          <div className="space-y-8">
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full bg-white/[0.02] border border-white/10 px-5 py-4 text-sm focus:border-gold outline-none transition-all placeholder:text-zinc-800 rounded-sm"
              />
            </div>
            ...
            <div className="relative group">
              ...
              <textarea 
                ...
                className="w-full bg-white/[0.02] border border-white/10 px-5 py-4 text-sm focus:border-gold outline-none transition-all placeholder:text-zinc-800 resize-none rounded-sm font-light italic"
              />
            </div>
          </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative group">
              ...
              <select className="w-full bg-white/[0.02] border border-white/10 px-5 py-4 text-sm focus:border-gold outline-none appearance-none rounded-sm">
            ...
            <div className="relative group">
              ...
              <select className="w-full bg-white/[0.02] border border-white/10 px-5 py-4 text-sm focus:border-gold outline-none appearance-none rounded-sm">
                <option className="bg-black">Gold / Steel</option>
            ...
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full bg-white/[0.02] border border-white/10 px-5 py-4 text-sm focus:border-gold outline-none transition-all placeholder:text-zinc-800 rounded-sm font-mono text-white"
              />
            </div>
          </section>
              ...
              {sizes.map(size => (
                <button 
                  ...
                  className={`relative flex-1 py-4 text-xs tracking-widest uppercase border rounded-sm transition-all ${
                    selectedSizes.includes(size) ? 'bg-white text-black border-white' : 'border-white/10 text-zinc-500 hover:border-gold'
                  }`}
                >
                  {selectedSizes.includes(size) && (
                    <div className="absolute top-1 right-1 text-gold"><X size={12} strokeWidth={1} /></div>
                  )}
                  {size}
                </button>
              ))}
          ...
          <div className="pt-8 border-t border-white/5 space-y-8">
            <div className="flex items-center gap-4">
              <div 
                ...
                className={`relative w-12 h-6 rounded-full cursor-pointer transition-colors ${isBestseller ? 'bg-gold' : 'bg-zinc-800 border border-white/10'}`}
              >
            ...
            <button type="submit" className="w-full flex items-center justify-center gap-2 bg-white text-black py-5 text-[11px] tracking-[0.4em] uppercase font-bold hover:bg-gold transition-colors duration-500 rounded-sm">
