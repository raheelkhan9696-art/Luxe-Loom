    ...
    <header className="flex flex-col md:flex-row justify-between items-end mb-12 gap-8">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          <p className="text-gold text-[10px] tracking-[0.5em] uppercase">Management</p>
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 w-full md:w-auto">
        ...
        <div className="relative w-full md:w-64 group">
          ...
          <input 
            ...
            className="w-full bg-transparent border-b border-white/10 pl-8 py-2 text-[10px] tracking-widest outline-none focus:border-gold transition-colors placeholder:text-zinc-800"
          />
        </div>
        ...
        <div className="flex items-center gap-6 border-x border-white/5 px-8 hidden lg:flex">
          ...
          <div className="relative cursor-pointer text-zinc-500 hover:text-white transition-colors">
            <Bell size={16} />
            <span className="absolute -top-1 -right-1 w-2 h-2 bg-gold rounded-full border border-[#050505]" />
          </div>
        </div>
        ...
        <button 
          onClick={onAction}
          className="w-full md:w-auto flex items-center justify-center gap-3 bg-white text-black px-8 py-4 text-[10px] font-bold tracking-[0.3em] uppercase hover:bg-gold transition-all duration-500 rounded-sm shadow-xl shadow-gold/5"
        >
